...
| API | 說明 |
| --- | --- |
| `GET /FunctionPermission/List?keyword=&isEnable=` | 取得功能操作權限平面清單 |
| `GET /FunctionPermission/Tree?isEnable=` | 取得功能操作權限樹狀資料 |
| `GET /FunctionPermission/GetById?functionPermissionId=1` | 依 FunctionPermissionId 取得單筆功能操作權限 |
| `POST /FunctionPermission/Create` | 新增功能操作權限 |
| `PUT /FunctionPermission/Update` | 更新功能操作權限 |
| `DELETE /FunctionPermission/Delete?functionPermissionId=1` | 刪除功能操作權限 |
| `POST /FunctionPermission/SyncFromMenuTree?includeDisabledMenus=false` | 依目前選單樹一鍵補足功能操作權限 |
| `GET /FunctionPermission/GetRoleGroupPermissions?roleGroupId=1&isEnable=true` | 取得指定角色群組已指派的功能操作權限清單 |
| `GET /FunctionPermission/RoleGroupTree?roleGroupId=1&isEnable=true` | 取得指定角色群組已指派的功能操作權限樹 |
| `PUT /FunctionPermission/UpdateRoleGroup` | 更新指定角色群組的功能操作權限 |
| `GET /FunctionPermission/UserTree?userId=admin&isEnable=true` | 取得指定使用者經由角色群組取得的功能操作權限樹 |
...
```http
POST /FunctionPermission/SyncFromMenuTree?includeDisabledMenus=false
```
